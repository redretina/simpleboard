...
<link href="${pageContext.request.contextPath }/css/styles.css"
	rel="stylesheet" />
<link href="${pageContext.request.contextPath }/css/admin/main.css"
	rel="stylesheet" />
<script
			...
			<div class="col-lg-8">
				<table id="info_table">
					<tr>
						<td>
							<div class="card">
								<span class="card-header">Statistics</span>
								<div class="card-body">
									<div class="list_area">
										<ul>
											<li>User : ${memberCount }</li>
											<li>Post : ${postCount }</li>
											<li>Comment : ${replyCount }</li>
										</ul>
									</div>
						...
						<td>
							<div class="card">
								<span class="card-header">Control</span>
								<div class="card-body">
									<div class="list_area">
										<ul>
											<li><a href="${pageContext.request.contextPath }/admin/member_list">Member</a></li>
