...
<link href="${pageContext.request.contextPath }/css/styles.css"
	rel="stylesheet" />
<link href="${pageContext.request.contextPath }/css/member_modify.css"
	rel="stylesheet" />
<script
		...
		<div class="row">
			<div class="col-lg-8">
				<form name="modifyForm" id="modifyForm" method="post"
					action="${pageContext.request.contextPath }/member_modify_action">
					<div class="card my-4">
						<h3 class="card-header">Modify Profile</h3>
						<div class="card-body">
							<div class="input-group">
								<ul class="modify_list">
									<li>ID <input type="text" name="id" id="id"
										readonly="readonly" class="form-control"
										value="${loginMember.id }"></li>
									<li>Password <input type="password" name="password"
										id="password" class="form-control"
										placeholder="Leave blank if you don't want to change"></li>
									<li>Username <input type="text" name="username" id="username"
										value="${loginMember.username }" class="form-control"></li>
									<li>Name <input type="text" name="name" id="name"
										value="${loginMember.name }" class="form-control"></li>
									<li>Phone <select name="phone1" id="phone1"
										class="form-control phone">
											<option value="010"
												<c:if test="${loginMember.phone.split('-')[0] eq '010' }"> selected="selected" </c:if>>010</option>
										...
										value="${loginMember.phone.split('-')[1] }" maxlength="4"
										class="form-control phone"> - <input type="text"
										name="phone3" id="phone3"
										value="${loginMember.phone.split('-')[2] }" maxlength="4"
										class="form-control phone">
									</li>
									<li>Email <input type="text" name="email" id="email"
										value="${loginMember.email }" class="form-control"></li>
								</ul>
							</div>
							<div id="messageDiv">
					...
					<input type="hidden" name="checkUsername" id="checkUsername" value="${loginMember.username }">
				</form>
			</div>
			<!-- Side widgets-->
			<div class="col-lg-4">
...
<script src="${pageContext.request.contextPath }/js/member_modify.js"></script>
