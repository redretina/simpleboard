...
<link href="${pageContext.request.contextPath }/css/styles.css"
	rel="stylesheet" />
<link href="${pageContext.request.contextPath }/css/post_write.css"
	rel="stylesheet" />
<script
...
<body>
	...
	<div class="container mt-5">
		<div class="row">
			<div class="col-lg-8">
				<form name="write_form" id="write_form" method="post"
					action="${pageContext.request.contextPath}/post_write_action">
					<div class="mt-2"></div>
					<h5>Category</h5>
					<select name="categoryNum" class="form-control">
						<c:forEach var="category" items="${categoryList }">
							<option value="${category.num }">${category.name }</option>
						</c:forEach>
					</select>
					<hr>
					<h5>Title</h5>
					...
					<hr>
					<!-- <div class="form-control" contenteditable="true" id="realContent"></div> -->
					<textarea name="content" id="content" class="form-control" wrap="hard"></textarea>
					<div id="btnArea">
...
<script src="${pageContext.request.contextPath }/js/post_write.js"></script>
